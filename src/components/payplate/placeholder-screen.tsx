  ...
  return (
    <AppShell>
      <section className="grid gap-5 md:grid-cols-[1fr_380px] md:items-center">
        ...
        <Card className="grid min-h-80 place-items-center bg-[radial-gradient(circle_at_top_right,rgba(13,159,110,.22),transparent_12rem)] p-6 text-center">
          <div>
            <div className="mx-auto grid size-20 place-items-center rounded-[24px] bg-primary text-3xl text-white shadow-[0_16px_34px_rgba(13,159,110,.28)]">🍽</div>
