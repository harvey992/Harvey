...
export function Drawer({ title, children, trigger = 'Open drawer' }: { title: string; children: ReactNode; trigger?: string }) {
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed inset-x-0 bottom-0 z-50 rounded-t-[28px] border bg-card p-6 shadow-2xl">
